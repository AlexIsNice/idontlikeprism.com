 ...
 */
$conf['settings']['app.title'] = 'Calendar (Free for personal use)';			// application title
...
$conf['settings']['admin.email'] = 'admin@idontlikeprism.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://idontlikeprism.com/phpsch/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'admin_phps940';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'pSa97-9.69';
$conf['settings']['database']['hostspec'] = 'localhost';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'admin_phps940';
/**
 ...
 */
$conf['settings']['install.password'] = 'nxypwvy0';
/**
 * Pages
 */
